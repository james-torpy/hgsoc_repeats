...
#-j y -R y -pe smp 2 -V Rscript /share/ClusterShare/thingamajigs/jamtor/projects/hgsoc_repeats/RNA-seq/scripts/fusion_repeats/2.find_repeat_fusions_draft3.R
