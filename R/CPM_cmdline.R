...
# define directories:
#homeDir <- "/share/ScratchGeneral/jamtor/share/ScratchGeneral/jamtor"
...
# adjust for only first of triplicates for development:
#lSizes <- lSizes[c(1, 4, 7, 10, 13, 16)]

save.image(file = paste0("/share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/results/R/", methodName, "/CPM_inputs.RData"))
methodName = "method1"
#load.image(file = paste0("/share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/results/R/," methodName, "/CPM_inputs.RData"))
...
CPMs$repeat_type[grep("telomere", CPMs$repeat_id)] <- "telomere"
...
save.image(file = paste0("/share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/results/R/", methodName, "/CPM_temp.RData"))
methodName = "method1"
#load.image(file = paste0("/share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/results/R/," methodName, "/CPM_temp.RData"))
...
save.image(file = paste0("/share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/results/R/", methodName, "/CPM_triplicates.RData"))
methodName = "method1"
#load.image(file = paste0("/share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/results/R/," methodName, "/CPM_triplicates.RData"))
